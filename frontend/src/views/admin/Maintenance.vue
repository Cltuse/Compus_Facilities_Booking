  ...
  <div class="maintenance-page">
    ...
    >
      <el-form :model="form" :rules="rules" ref="formRef" class="maintenance-form" label-width="100px">
        <el-form-item label="设施" prop="equipmentId">
          <el-select v-model="form.equipmentId" style="width: 100%;" placeholder="请选择设施">
            <el-option
...
const rules = {
  equipmentId: [{ required: true, message: '请选择设施', trigger: 'change' }],
    ...
    if (result.code === 200) {
      ...
      if (isSearchMode.value && searchKeyword.value.trim()) {
        ...
        filteredData = filteredData.filter(item =>
          (item.equipmentName && item.equipmentName.toLowerCase().includes(keyword)) ||
