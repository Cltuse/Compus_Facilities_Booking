  ...
  <div class="maintainer-maintenance">
      ...
      <el-row :gutter="20" align="middle">
        <el-col :span="16">
          <el-space>
            ...
            >
              <el-option label="所有记�? value="" />
              <el-option label="已维�? value="MAINTAINED" />
              <el-option label="未维�? value="UNMAINTAINED" />
            </el-select>
            ...
            >
              ...
              <el-option label="待处�? value="PENDING" />
    ...
    <div class="filter-stats" v-if="total > 0 || statusFilter || maintenanceStatusFilter">
      <el-tag type="info" size="small" v-if="maintenanceStatusFilter">
        {{ getMaintenanceStatusFilterText(maintenanceStatusFilter) }}: {{ total }} 条记�?
      </el-tag>
      <el-tag type="info" size="small" v-if="statusFilter" style="margin-left: 8px;">
        {{ getMaintenanceStatusText(statusFilter) }}: {{ total }} �?
      </el-tag>
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column prop="status" label="状�? width="90" align="center">
          <template #default="{ row }">
            <el-tag
    ...
    >
      ...
      <div class="dialog-content">
        ...
        >
          ...
          <el-form-item label="开始时�? prop="startTime" align="center">
            <el-date-picker
          ...
          <template v-if="form.id">
            ...
            <el-form-item label="状�? prop="status" align="center">
              <el-select v-model="form.status" style="width: 100%" placeholder="请选择状�?>
                <el-option label="待处�? value="PENDING" />
                <el-option label="进行�? value="IN_PROGRESS" />
                <el-option label="已完�? value="COMPLETED" />
                <el-option label="已取�? value="CANCELLED" />
...
const maintenanceStatusFilter = ref(''); // 已维�?未维�?所有记录筛�?
...
const rules = {
  ...
  description: [
    { required: true, message: '请输入维护描�?, trigger: 'blur' },
    { max: 500, message: '描述长度不能超过500个字�?, trigger: 'blur' }
  ],
  startTime: [
    { required: false, message: '请选择开始时�?, trigger: 'change' }
  ],
  endTime: [
...
const getMaintenanceStatusFilterText = (filter) => {
  switch (filter) {
    case 'MAINTAINED': return '已维�?;
    case 'UNMAINTAINED': return '未维�?;
    default: return '所有记�?;
  }
};
